  ...
  return (
    <div className="min-h-screen bg-agricultural-hero bg-cover bg-center bg-no-repeat relative flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-6xl mx-auto px-6">
        <div className="bg-gradient-to-br from-[#00000075] to-[#000] backdrop-blur-xl rounded-3xl p-5 md:p-12 shadow-2xl border border-white/40 animate-fade-in">
          {/* Logo with icon */}
          ...
          {/* Feature highlights */}
          <div className="flex flex-wrap justify-center md:gap-6 gap-1 mb-10">
            <div className="flex items-center bg-white/10 rounded-full px-4 py-2 backdrop-blur-sm">
              ...
              <span className="text-white md:text-sm text-[12px] font-medium">Increase Yields</span>
            </div>
            <div className="flex items-center bg-white/10 rounded-full px-4 py-2 backdrop-blur-sm">
              <Leaf className="w-5 h-5 text-green-300 mr-2 " />
              <span className="text-white md:text-sm text-[12px] font-medium">Sustainable Farming</span>
            </div>
            <div className="flex items-center bg-white/10 rounded-full px-4 py-2 backdrop-blur-sm">
              <Users className="w-5 h-5 text-green-300 mr-2" />
              <span className="text-white md:text-sm text-[12px] font-medium">Expert Support</span>
            </div>
          </div>
